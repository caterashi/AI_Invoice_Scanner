...
from ai_extractor import (
    ...
    KUF_FIELDS,
    PROMET_FIELDS,
    extract_kif_from_pdf,
    extract_kuf_from_pdf,
...
def _render_kind_upload(kind: str) -> None:
    ...
    st.markdown(
        f"<div class='upload-card'><b>{cfg['title']}</b><br><span class='upload-muted'>{cfg['subtitle']}</span></div>",
        unsafe_allow_html=True,
    )
